...
class SISDRiMetrics(BaseMetric):
    def __call__(self, s1: torch.Tensor, s2: torch.Tensor, s1_predicted: torch.Tensor, s2_predicted: torch.Tensor, mix: torch.Tensor, **batch):
